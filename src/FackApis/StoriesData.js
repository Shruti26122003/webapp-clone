// Import profile and story images
...
const Stories = [
    { id: 1, name: 'Irfan Nazir', storyProfile: StoryProfile1, story: Story1 },
    { id: 2, name: 'Alyxa Doie', storyProfile: StoryProfile2, story: Story2 },
    { id: 3, name: 'David Mark', storyProfile: StoryProfile3, story: Story3 },
    { id: 4, name: 'Khatrin Frue', storyProfile: StoryProfile4, story: Story4 },
    { id: 5, name: 'Akib Khan', storyProfile: StoryProfile5, story: Story5 },
    { id: 6, name: 'Puza Sing', storyProfile: StoryProfile6, story: Story6 },
    { id: 7, name: 'Samira Mahi', storyProfile: StoryProfile7, story: Story7 },
    { id: 8, name: 'Saima Abir', storyProfile: StoryProfile8, story: Story8 },
    { id: 9, name: 'Neha Shill', storyProfile: StoryProfile9, story: Story9 }
];
